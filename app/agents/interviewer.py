...
class InterviewerAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ...
            Specialist Whispers (Priority Order): {whispers}
            ...
            6. PERSISTENCE MODE: Do NOT let the user exit early. If they try, politely say: "I appreciate that, but to ensure your project succeeds, I need to cover a few more areas..." and ask the next question.
    ...
    async def run(self, user_input: str, whispers: List[Dict], context_summary: str = "", recent_history: str = "") -> str:
        formatted_whispers = "\n".join([f"- [{w['agent_name']}] (Priority {w['priority']}): {w['question']}" for w in whispers])
